...
const getData = async () => {
    ...
    try{
      ...
      setMyData(data.MARVELSTUDIOSORIGINALSMOVIES[0].data);
    }
    catch(error){
         console.log(error);
    }
...
useEffect(()=>{
  ...
  return (
    ...
    <Text style={Styles.heading}>Marvel Studios Movies</Text>
...
export default MarvelStudiosMovies;