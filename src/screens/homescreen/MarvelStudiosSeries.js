...
const getData = async () => {
    ...
    try{
      ...
      setMyData(data.MARVELSTUDIOSORIGINALSERIES[0].data);
    }
    catch(error){
         console.log(error);
    }
...
useEffect(()=>{
  ...
  return (
    ...
    <Text style={Styles.heading}>Marvel Studios Series</Text>
...
export default MarvelStudiosSeries;